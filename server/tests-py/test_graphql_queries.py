...
class TestGraphQLQueryBasicBigquery:
    ...
    def test_empty_perms(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/empty_perms.yaml", transport)

    def test_timestamp_perm(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/timestamp_perm.yaml", transport)

    def test_exact_article_id(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/exact_article_id.yaml", transport)

    def test_perms_published_articles(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f"{self.dir()}/perms_published_articles.yaml", transport
        )

    # types
    def test_select_query_all_types(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/select_query_all_types.yaml", transport)

    # batching # works only with http, not with websocket
    def test_select_query_batching(self, hge_ctx, transport):
        if transport == 'http':
            check_query_f(hge_ctx, f"{self.dir()}/select_query_batching.yaml", transport)

    def test_select_query_batching_with_one_error(self, hge_ctx, transport):
        if transport == 'http':
            check_query_f(
                hge_ctx,
                f"{self.dir()}/select_query_batching_with_one_error.yaml",
                transport,
            )
    ...
    def test_select_query_top_level_fragment(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_top_level_fragment.yaml',
            transport,
        )

    def test_select_query_nested_fragment(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_query_nested_fragment.yaml', transport
        )

    def test_select_query_fragment_cycles(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_query_fragment_cycles.yaml', transport
        )

    def test_select_query_fragment_with_variable(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_fragment_with_variable.yaml',
            transport,
        )
    ...
    def test_select_query_invalid_escape_sequence(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f"{self.dir()}/select_query_invalid_escape_sequence.yaml",
            transport,
        )

    # aggregates
    def test_select_join_provenance_queries(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/select_join_provenance.yaml", transport)

    # offsets
    def test_offset_regression(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/offset_regression.yaml", transport)

    # BigQuery-specific configuration: global_limit
    def test_global_limit(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/global_limit.yaml", transport)

    def test_basic_remote_join(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/basic_remote_joins.yaml", transport)

    def test_nested_array_relationships(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f"{self.dir()}/nested_array_relationships.yaml", transport
        )

    def test_agg_nodes(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/agg_nodes.yaml", transport)

    def test_distinct_on(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/distinct_on.yaml", transport)
    ...
    def test_timestamp_filter(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/timestamp_filter.yaml", transport)
...
class TestGraphQLQueryBoolExpSearchBigquery:
    ...
    def test_city_where_like(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_like_bigquery.yaml',
            transport,
        )
    ...
    def test_city_where_not_like(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_nlike_bigquery.yaml',
            transport,
        )
...
class TestGraphQLQueryBasicPostgresMSSQLCitus:
    ...
    def test_select_query_multiple_columns_arr_fkey(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f"{self.dir()}/select_multiple_columns_arr_fkey.yaml",
            transport,
        )
    ...
    def test_select_query_multiple_columns_obj_fkey(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f"{self.dir()}/select_multiple_columns_obj_fkey.yaml",
            transport,
        )
...
class TestGraphQLQueryBasicMSSQL:
    ...
    def test_select_various_mssql_types(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_query_test_types_mssql.yaml', transport
        )

    def test_select_query_user_col_change(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/select_query_user_col_change_mssql.yaml")

    def test_nodes_aggregates_mssql(self, hge_ctx, transport):
        check_query_f(hge_ctx, f"{self.dir()}/nodes_aggregates_mssql.yaml", transport)

    def test_nodes_aggregates_conditions_mssql(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f"{self.dir()}/nodes_aggregates_conditions_mssql.yaml",
            transport,
        )

    def test_author_with_permission(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/author_with_permission_mssql.yaml', transport
        )
...
class TestGraphQLQueryBasicPostgres:
    def test_select_various_postgres_types(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_test_types_postgres.yaml',
            transport,
        )
    ...
    def test_nested_select_with_foreign_key_alter(self, hge_ctx, transport):
        ...
        check_query_f(
            hge_ctx,
            f"{self.dir()}/nested_select_with_foreign_key_alter.yaml",
            transport,
        )

    def test_select_query_user_col_change(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f"{self.dir()}/select_query_user_col_change_postgres.yaml"
        )

    def test_select_query_person_citext(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f"{self.dir()}/select_query_person_citext.yaml", transport
        )
    ...
    def test_select_query_batching_with_mutation(self, hge_ctx, transport):
        ...
        check_query_f(
            hge_ctx,
            f"{self.dir()}/select_query_batching_with_mutation.yaml",
            transport,
        )
    ...
    def test_create_invalid_fkey_relationship(self, hge_ctx, transport):
        resp = hge_ctx.v1q_f(
            f'{self.dir()}/setup_invalid_fkey_relationship.yaml',
...
class TestGraphQLQueryAgg:
    ...
    def test_article_agg_count_sum_avg_max_min_with_aliases(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/article_agg_count_sum_avg_max_min_with_aliases.yaml',
            transport,
        )

    def test_article_agg_where(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/article_agg_where.yaml', transport)

    def test_author_agg_with_articles(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/author_agg_with_articles.yaml', transport
        )

    def test_author_agg_with_articles_where(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/author_agg_with_articles_where.yaml', transport
        )

    def test_article_deeply_nested_aggregate(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/article_deeply_nested_aggregate.yaml',
            transport,
        )
...
class TestGraphQLQueryAggPermPostgresMSSQL:
    ...
    def test_author_agg_articles(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/author_agg_articles.yaml', transport)

    def test_article_agg_fail(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/article_agg_fail.yaml', transport)

    def test_author_articles_agg_fail(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/author_articles_agg_fail.yaml', transport
        )

    def test_author_post_agg_order_by(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/author_post_agg_order_by.yaml', transport
        )

    def test_article_agg_without_select_access_to_any_col(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/article_agg_with_role_without_select_access.yaml',
            transport,
        )

    def test_article_agg_with_filter(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/article_agg_with_filter.yaml', transport)
...
class TestGraphQLQueryAggPermPostgres:
    ...
    def test_article_agg_with_select_access(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/article_agg_with_role_with_select_access.yaml',
            transport,
        )
...
class TestGraphQLQueryLimits:
    ...
    def test_limit_1(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_query_article_limit_1.yaml', transport
        )

    @pytest.mark.parametrize("transport", ['http', 'websocket'])
    def test_limit_2(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_query_article_limit_2.yaml', transport
        )

    def test_limit_null(self, hge_ctx):
        check_query_f(hge_ctx, f'{self.dir()}/select_query_article_limit_null.yaml')

    @pytest.mark.parametrize("transport", ['http', 'websocket'])
    def test_err_str_limit_error(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_article_string_limit_error.yaml',
            transport,
        )
    ...
    def test_err_neg_limit_error(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_article_neg_limit_error.yaml',
            transport,
        )
...
class TestGraphQLQueryOffsets:
    ...
    def test_offset_1_limit_2(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_article_offset_1_limit_2.yaml',
            transport,
        )
    ...
    def test_offset_2_limit_1(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_article_offset_2_limit_1.yaml',
            transport,
        )
    ...
    def test_int_as_string_offset(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_article_string_offset.yaml',
            transport,
        )

    def test_err_neg_offset_error(self, hge_ctx):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_query_article_neg_offset_error.yaml'
        )
...
class TestGraphQLQueryBoolExpBasicPostgresMSSQL:
    def test_order_delivered_at_is_null(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_order_delivered_at_is_null.yaml',
            transport,
        )
    ...
    def test_order_delivered_at_is_not_null(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_order_delivered_at_is_not_null.yaml',
            transport,
        )
    ...
    def test_author_article_where_not_equal(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_where_neq.yaml',
            transport,
        )

    def test_author_article_where_greater_than(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_author_article_where_gt.yaml', transport
        )

    def test_author_article_where_greater_than_or_equal(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_where_gte.yaml',
            transport,
        )

    def test_author_article_where_less_than(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_author_article_where_lt.yaml', transport
        )

    def test_author_article_where_not_less_than(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_where_not_lt.yaml',
            transport,
        )
    ...
    def test_author_article_where_less_than_or_equal(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_where_lte.yaml',
            transport,
        )
    ...
    def test_article_author_is_published_and_registered(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_article_author_is_published_and_registered.yaml',
            transport,
        )
    ...
    def test_article_author_not_published_nor_registered(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_article_author_not_published_or_not_registered.yaml',
            transport,
        )

    def test_author_article_where_in(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_author_article_where_in.yaml', transport
        )

    def test_author_article_where_nin(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_where_nin.yaml',
            transport,
        )
    ...
    def test_author_article_where_permissions(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_where_permissions.yaml',
            transport,
        )
...
class TestGraphQLQueryBoolExpBasicPostgres:
    def test_author_article_operator_ne_not_found_err(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_operator_ne_not_found_err_postgres.yaml',
            transport,
        )
    ...
    def test_author_article_where_in_empty_array(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_where_in_empty_array_postgres.yaml',
            transport,
        )
    ...
    def test_author_article_where_nin_empty_array(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_where_nin_empty_array_postgres.yaml',
            transport,
        )
    ...
    def test_article_author_unexpected_operator_in_where_err(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_unexpected_operator_in_where_err_postgres.yaml',
            transport,
        )
    ...
    def test_uuid_test_in_uuid_col(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_uuid_test_in_uuid_col_postgres.yaml',
            transport,
        )

    def test_self_referential_relationships(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/self_referential_relationships.yaml', transport
        )

    def test_query_account_permission_success(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/query_account_permission_success.yaml',
            transport,
        )

    def test_query_account_permission_fail(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/query_account_permission_fail.yaml', transport
        )

    def test_in_sql_identifier_array(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/in_sql_identifier_array.yaml', transport)
...
class TestGraphQLQueryBoolExpBasicMSSQL:
    def test_author_article_operator_ne_not_found_err(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_operator_ne_not_found_err_mssql.yaml',
            transport,
        )
    ...
    def test_article_author_unexpected_operator_in_where_err(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_unexpected_operator_in_where_err_mssql.yaml',
            transport,
        )
    ...
    def test_uuid_test_in_uuid_col(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_uuid_test_in_uuid_col_mssql.yaml',
            transport,
        )

    def test_bools(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_bools_mssql.yaml', transport)

    def test_create_invalid_fkey_relationship(self, hge_ctx, transport):
        resp = hge_ctx.v1metadataq_f(
            f'{self.dir()}/setup_invalid_fkey_relationship_mssql.yaml',
            expected_status_code=400,
        )
...
class TestGraphqlQueryPermissions:
    ...
    def test_user_select_unpublished_articles(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/user_select_query_unpublished_articles.yaml',
            transport,
        )
    ...
    def test_user_select_query_article_author(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/user_select_query_article_author.yaml',
            transport,
        )
    ...
    def test_user_only_other_users_published_articles(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/user_can_query_other_users_published_articles.yaml',
            transport,
        )
    ...
    def test_anonymous_only_published_articles(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/anonymous_can_only_get_published_articles.yaml',
            transport,
        )
    ...
    def test_anonymous_only_published_articles_v1alpha1(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/anonymous_can_only_get_published_articles_v1alpha1.yaml',
            transport,
        )

    def test_user_cannot_access_remarks_col(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/user_cannot_access_remarks_col.yaml', transport
        )

    def test_user_can_query_geometry_values_filter(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/user_can_query_geometry_values_filter.yaml',
            transport,
        )
    ...
    def test_user_can_query_geometry_values_filter_session_vars(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/user_can_query_geometry_values_filter_session_vars.yaml',
            transport,
        )
    ...
    def test_user_can_query_jsonb_values_filter(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/user_can_query_jsonb_values_filter.yaml',
            transport,
        )
    ...
    def test_user_can_query_jsonb_values_filter_session_vars(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/user_can_query_jsonb_values_filter_session_vars.yaml',
            transport,
        )

    def test_artist_select_query_Track_fail(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/artist_select_query_Track_fail.yaml', transport
        )

    def test_artist_select_query_Track(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/artist_select_query_Track.yaml', transport
        )

    def test_artist_search_tracks(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/artist_search_tracks.yaml', transport)

    def test_artist_search_tracks_aggregate(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/artist_search_tracks_aggregate.yaml', transport
        )

    def test_staff_passed_students(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/staff_passed_students.yaml', transport)

    def test_user_query_auction(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/user_query_auction.yaml', transport)
    ...
    def test_jsonb_has_any(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/jsonb_has_any.yaml', transport)

    def test_in_and_nin(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/in_and_nin.yaml', transport)

    def test_iregex(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/iregex.yaml', transport)

    def test_user_accessing_books_by_pk_should_fail(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/user_should_not_be_able_to_access_books_by_pk.yaml',
        )

    def test_author_articles_without_required_headers_set(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_articles_without_required_headers.yaml',
            transport,
        )

    def test_reader_author(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/reader_author.yaml', transport)

    def test_tutor_get_students(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/tutor_get_students.yaml', transport)

    def test_tutor_get_students_session(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/tutor_get_students_session.yaml', transport
        )
...
class TestGraphQLInheritedRolesSchema:
    ...
    def test_basic_inherited_role(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/basic_inherited_roles.yaml')

    def test_inherited_role_when_some_roles_may_not_have_permission_configured(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/inherited_role_with_some_roles_having_no_permissions.yaml',
        )
    ...
    def test_inherited_role_inherits_from_inherited_role(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/inherited_role_parent_is_another_inherited_role.yaml',
        )
...
class TestGraphQLQueryBoolExpSearchPostgres:
    ...
    def test_city_where_like(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_city_where_like.yaml', transport)

    def test_city_where_not_like(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_city_where_nlike.yaml', transport)

    def test_city_where_ilike(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_ilike_postgres.yaml',
            transport,
        )
    ...
    def test_city_where_not_ilike(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_nilike_postgres.yaml',
            transport,
        )
    ...
    def test_city_where_similar(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_similar_postgres.yaml',
            transport,
        )
    ...
    def test_city_where_not_similar(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_not_similar_postgres.yaml',
            transport,
        )
    ...
    def test_city_where_regex(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_regex_postgres.yaml',
            transport,
        )
    ...
    def test_city_where_nregex(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_nregex_postgres.yaml',
            transport,
        )
    ...
    def test_city_where_iregex(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_iregex_postgres.yaml',
            transport,
        )
    ...
    def test_city_where_niregex(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_city_where_niregex_postgres.yaml',
            transport,
        )
    ...
    def test_project_where_ilike(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_project_where_ilike_postgres.yaml',
            transport,
        )
...
class TestGraphQLQueryBoolExpSearchMSSQL:
    ...
    def test_city_where_like(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_city_where_like_mssql.yaml', transport
        )

    def test_city_where_not_like(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_city_where_nlike_mssql.yaml', transport
        )
...
class TestGraphQLQueryBoolExpJsonB:
    ...
    def test_query_cast_geometry_to_geography(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/query_cast_jsonb_to_string.yaml', transport
        )

    def test_jsonb_contains_article_latest(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_article_author_jsonb_contains_latest.yaml',
            transport,
        )
    ...
    def test_jsonb_contains_article_beststeller(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_author_article_jsonb_contains_bestseller.yaml',
            transport,
        )
    ...
    def test_jsonb_contained_in_latest(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_article_author_jsonb_contained_in_latest.yaml',
            transport,
        )
    ...
    def test_jsonb_contained_in_bestseller_latest(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_article_author_jsonb_contained_in_bestseller_latest.yaml',
            transport,
        )
    ...
    def test_jsonb_has_key_sim_type(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_product_jsonb_has_key_sim_type.yaml',
            transport,
        )
    ...
    def test_jsonb_has_keys_any_os_operating_system(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_product_jsonb_has_keys_any_os_operating_system.yaml',
            transport,
        )
    ...
    def test_jsonb_has_keys_all_touchscreen_ram(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_product_jsonb_has_keys_all_ram_touchscreen.yaml',
            transport,
        )
...
class TestGraphQLQueryBoolExpPostGIS:
    ...
    def test_query_using_point(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/query_using_point.yaml', transport)

    def test_query_using_line(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/query_using_line.yaml', transport)

    def test_query_using_polygon(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/query_using_polygon.yaml', transport)

    def test_query_geography_spatial_ops(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/query_geography_spatial_ops.yaml', transport
        )

    def test_query_geometry_3d_spatial_ops(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/query_geometry_3d_spatial_ops.yaml', transport
        )

    def test_query_cast_geometry_to_geography(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/query_cast_geometry_to_geography.yaml',
            transport,
        )
    ...
    def test_query_cast_geography_to_geometry(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/query_cast_geography_to_geometry.yaml',
            transport,
        )
    ...
    def test_query_illegal_cast_is_not_allowed(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/query_illegal_cast_is_not_allowed.yaml',
            transport,
        )
...
class TestGraphQLQueryBoolExpRaster:
    ...
    def test_query_st_intersects_geom_nband(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/query_st_intersects_geom_nband.yaml', transport
        )

    def test_query_st_intersects_geom_nband_no_rows(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/query_st_intersects_geom_nband_no_rows.yaml',
            transport,
        )

    def test_query_st_intersects_rast(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/query_st_intersects_rast.yaml', transport
        )

    def test_query_st_intersects_rast_no_rows(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/query_st_intersects_rast_no_rows.yaml',
            transport,
        )

    def test_query_st_intersects_rast_fail(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/query_st_intersects_rast_fail.yaml', transport
        )
...
class TestGraphQLQueryOrderBy:
    def test_articles_order_by_without_id(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/articles_order_by_without_id.yaml', transport
        )

    def test_articles_order_by_rel_author_id(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/articles_order_by_rel_author_id.yaml',
            transport,
        )
    ...
    def test_articles_order_by_rel_author_rel_contact_phone(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/articles_order_by_rel_author_rel_contact_phone.yaml',
            transport,
        )

    def test_articles_order_by_null(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/articles_order_by_null.yaml', transport)

    def test_album_order_by_tracks_count(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/album_order_by_tracks_count.yaml', transport
        )

    def test_album_order_by_tracks_duration_avg(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/album_order_by_tracks_duration_avg.yaml',
            transport,
        )

    def test_album_order_by_tracks_max_name(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/album_order_by_tracks_max_name.yaml', transport
        )

    def test_album_order_by_tracks_bytes_stddev(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/album_order_by_tracks_bytes_stddev.yaml',
            transport,
        )
    ...
    def test_employee_distinct_department_order_by_salary_desc(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/employee_distinct_department_order_by_salary_desc.yaml',
            transport,
        )
    ...
    def test_employee_distinct_department_order_by_salary_asc(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/employee_distinct_department_order_by_salary_asc.yaml',
            transport,
        )

    def test_employee_distinct_fail(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/employee_distinct_fail.yaml', transport)

    def test_album_order_by_tracks_tags(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/album_order_by_tracks_tags.yaml', transport
        )

    def test_Track_order_by_size(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/Track_order_by_size.yaml', transport)

    def test_author_order_by_get_articles_aggregate(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/author_order_by_get_articles_aggregate.yaml',
            transport,
        )
...
class TestGraphQLQueryCustomSchema:
    ...
    def test_author(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/author.yaml', transport)

    def test_article(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/article.yaml', transport)
...
class TestGraphQLQueryEnums:
    ...
    def test_introspect(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/introspect.yaml', transport)

    def test_introspect_user_role(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/introspect_user_role.yaml', transport)

    def test_select_enum_field(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_enum_field.yaml', transport)

    def test_select_where_enum_eq(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_where_enum_eq.yaml', transport)

    def test_select_where_enum_eq_bad_value(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_where_enum_eq_bad_value.yaml', transport
        )

    def test_select_where_enum_eq_string(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_where_enum_eq_string.yaml', transport
        )

    def test_select_where_enum_eq_variable(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_where_enum_eq_variable.yaml', transport
        )

    def test_select_where_enum_eq_variable_bad_value(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_where_enum_eq_variable_bad_value.yaml',
            transport,
        )
    ...
    def test_select_where_enum_eq_without_enum_table_visibility(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_where_enum_eq_without_enum_table_visibility.yaml',
            transport,
        )
...
class TestGraphQLQueryComputedFields:
    ...
    def test_computed_fields(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/computed_fields.yaml', transport)

    def test_computed_fields_permission(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/computed_fields_permission.yaml', transport
        )

    def test_locations(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/locations.yaml', transport)

    def test_float_test(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/float_test.yaml', transport)

    def test_tracked_function_as_computed_field(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/tracked_function_as_comp_field.yaml')

    def test_scalar_computed_field_filter(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/scalar_computed_field_filter.yaml')

    def test_table_computed_field_filter(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/table_computed_field_filter.yaml')

    def test_table_computed_field_filter_fail(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/table_computed_field_filter_fail.yaml')

    def test_table_computed_field_filter_session_argument(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/table_computed_field_filter_session_argument.yaml',
        )
...
class TestGraphQLQueryCaching:
    ...
    def test_include_directive(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/include_directive.yaml', transport)

    def test_introspection(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/introspection.yaml', transport)
...
class TestUnauthorizedRolePermission:
    ...
    def test_unauth_role(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/unauthorized_role.yaml', transport, False
        )
...
class TestFallbackUnauthorizedRoleCookie:
    ...
    def test_fallback_unauth_role_jwt_cookie_not_set(self, hge_ctx):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/cookie_header_absent_unauth_role_set.yaml',
            add_auth=False,
        )
...
class TestMissingUnauthorizedRoleAndCookie:
    ...
    def test_error_unauth_role_not_set_jwt_cookie_not_set(self, hge_ctx):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/cookie_header_absent_unauth_role_not_set.yaml',
            add_auth=False,
        )
...
class TestGraphQLExplainPostgresMSSQL:
    ...
    def test_limit_query(self, hge_ctx):
        self.with_admin_secret("query", hge_ctx, f'{self.dir()}/limit_query.yaml')

    def test_limit_orderby_column_query(self, hge_ctx):
        self.with_admin_secret(
            "query", hge_ctx, f'{self.dir()}/limit_orderby_column_query.yaml'
        )

    def test_limit_orderby_relationship_query(self, hge_ctx):
        self.with_admin_secret(
            "query", hge_ctx, f'{self.dir()}/limit_orderby_relationship_query.yaml'
        )
    ...
    def test_limit_offset_orderby_relationship_query(self, hge_ctx):
        self.with_admin_secret(
            "query",
            hge_ctx,
            f'{self.dir()}/limit_offset_orderby_relationship_query.yaml',
        )

    def test_orderby_array_relationship_query(self, hge_ctx):
        self.with_admin_secret(
            "query", hge_ctx, f'{self.dir()}/orderby_array_relationship_query.yaml'
        )
...
class TestRelayQueriesBasic:
    ...
    def test_article_connection(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/article_connection.yaml', transport)

    def test_author_connection(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/author_connection.yaml', transport)

    def test_author_with_articles_view_connection(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/author_with_articles_view_connection.yaml',
            transport,
        )

    def test_search_articles_connection(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/search_articles_connection.yaml', transport
        )

    def test_node(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/node.yaml', transport)

    def test_only_pageinfo(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/only_pageinfo.yaml', transport)
    ...
    def test_article_no_orderby_forward_pagination(self, hge_ctx, transport):
        _test_relay_pagination(
            hge_ctx,
            transport,
            f"{self.dir()}/article_pagination_no_orderby/forward",
            3,
        )
    ...
    def test_article_no_orderby_backward_pagination(self, hge_ctx, transport):
        _test_relay_pagination(
            hge_ctx,
            transport,
            f"{self.dir()}/article_pagination_no_orderby/backward",
            3,
        )
    ...
    def test_author_orderby_articles_aggregate_orderby_forward_pagination(self, hge_ctx, transport):
        _test_relay_pagination(
            hge_ctx,
            transport,
            f"{self.dir()}/author_pagination_articles_aggregate_orderby/forward",
            2,
        )
    ...
    def test_author_orderby_articles_aggregate_orderby_backward_pagination(self, hge_ctx, transport):
        _test_relay_pagination(
            hge_ctx,
            transport,
            f"{self.dir()}/author_pagination_articles_aggregate_orderby/backward",
            3,
        )
    ...
    def test_first_and_last_fail(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f"{self.dir()}/pagination_errors/first_and_last.yaml",
            transport,
        )
    ...
    def test_after_and_before_fail(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f"{self.dir()}/pagination_errors/after_and_before.yaml",
            transport,
        )
    ...
    def test_insufficient_data(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/node_id_errors/insufficient_data.yaml',
            transport,
        )
    ...
    def test_invalid_column_value(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/node_id_errors/invalid_column_value.yaml',
            transport,
        )

    def test_invalid_id(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/node_id_errors/invalid_id.yaml', transport
        )

    def test_missing_columns(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/node_id_errors/missing_columns.yaml', transport
        )

    def test_non_array_id(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/node_id_errors/non_array_id.yaml', transport
        )

    def test_unexpected_columns(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/node_id_errors/unexpected_columns.yaml',
            transport,
        )
    ...
    def test_invalid_node_id_version(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/node_id_errors/invalid_node_id_version.yaml',
            transport,
        )
    ...
    def test_non_integer_version(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/node_id_errors/non_integer_version.yaml',
            transport,
        )
...
class TestRelayQueriesPermissions:
    ...
    def test_author_node(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/author_node.yaml', transport)

    def test_author_node_null(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/author_node_null.yaml', transport)

    # Article forward pagination
    def test_article_pagination_forward(self, hge_ctx, transport):
        _test_relay_pagination(
            hge_ctx, transport, f'{self.dir()}/article_pagination/forward', 2
        )

    def test_article_pagination_backward(self, hge_ctx, transport):
        _test_relay_pagination(
            hge_ctx, transport, f'{self.dir()}/article_pagination/backward', 2
        )

def _test_relay_pagination(hge_ctx, transport, test_file_prefix, no_of_pages):
    for i in range(no_of_pages):
        page_no = i + 1
        test_file = f"page_{str(page_no)}.yaml"
        check_query_f(hge_ctx, f"{test_file_prefix}/{test_file}", transport)
...
class TestGraphQLQueryFunctionPermissions:
    ...
    def test_access_function_with_table_permissions(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}get_messages_with_table_permissions.yaml')

    def test_access_function_without_permission_configured(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}get_articles_without_permission_configured.yaml'
        )

    def test_access_function_with_permission_configured(self, hge_ctx, transport):
        hge_ctx.v1metadataq_f(f'{self.dir()}add_function_permission_get_articles.yaml')
        check_query_f(
            hge_ctx, f'{self.dir()}get_articles_with_permission_configured.yaml'
        )
...
class TestGraphQLQueryBoolExpLtree:
    def test_select_path_where_ancestor(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_path_where_ancestor.yaml')

    def test_select_path_where_ancestor_array(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_path_where_ancestor_array.yaml')

    def test_select_path_where_descendant(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_path_where_descendant.yaml')

    def test_select_path_where_descendant_array(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_path_where_descendant_array.yaml')

    def test_select_path_where_matches(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_path_where_matches.yaml')

    def test_select_path_where_matches_array(self, hge_ctx, transport):
        check_query_f(hge_ctx, f'{self.dir()}/select_path_where_matches_array.yaml')

    def test_select_path_where_matches_ltxtquery(self, hge_ctx, transport):
        check_query_f(
            hge_ctx, f'{self.dir()}/select_path_where_matches_ltxtquery.yaml'
        )
...
class TestGraphQLQueryBoolExpSpatialMSSQL:
    def test_select_spatial_mssql_types(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_equals(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_equals_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_contains(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_contains_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_crosses(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_geom_where_st_crosses_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_intersects(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_intersects_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_overlaps(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_overlaps_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_within(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_within_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_touches(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_touches_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_crosses_geojson(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_geom_where_st_crosses_geojson_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_contains_geojson(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_contains_geojson_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_equals_geojson(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_equals_geojson_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_intersects_geojson(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_intersects_geojson_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_touches_geojson(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_touches_geojson_mssql.yaml',
            transport,
        )
    ...
    def test_select_spatial_mssql_types_where_st_within_geojson(self, hge_ctx, transport):
        check_query_f(
            hge_ctx,
            f'{self.dir()}/select_query_spatial_types_where_st_within_geojson_mssql.yaml',
            transport,
        )
