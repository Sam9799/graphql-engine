...
class TestAddRemoteSchemaPermissions:
    ...
    def test_add_permission_with_valid_subset_of_fields(self, hge_ctx):
        hge_ctx.v1metadataq_f(
            f'{self.dir()}add_permission_with_valid_subset_of_fields.yaml'
        )
    ...
    def test_update_remote_schema_details_with_permissions_set(self, hge_ctx):
        ...
        hge_ctx.v1metadataq_f(f'{self.dir()}update_remote_schema/update_schema.yaml')
        ...
        hge_ctx.v1metadataq_f(
            f'{self.dir()}update_remote_schema/revert_to_original_config.yaml'
        )
    ...
    def test_update_remote_schema_details_with_permissions_set_with_error(self, hge_ctx):
        ...
        hge_ctx.v1metadataq_f(
            f'{self.dir()}update_remote_schema/update_schema_error.yaml',
            expected_status_code=400,
        )

    def test_add_permission_with_valid_subset_of_arguments(self, hge_ctx):
        hge_ctx.v1metadataq_f(
            f'{self.dir()}add_permission_with_valid_subset_of_arguments.yaml'
        )

    def test_role_based_schema_enums_validation(self, hge_ctx):
        check_query_f(hge_ctx, f'{self.dir()}role_based_schema_enum_validations.yaml')

    def test_role_based_schema_scalars_validation(self, hge_ctx):
        check_query_f(hge_ctx, f'{self.dir()}role_based_schema_scalar_validation.yaml')

    def test_role_based_schema_interface_validation(self, hge_ctx):
        check_query_f(
            hge_ctx, f'{self.dir()}role_based_schema_interface_validation.yaml'
        )

    def test_role_based_schema_union_validation(self, hge_ctx):
        check_query_f(hge_ctx, f'{self.dir()}role_based_schema_union_validation.yaml')

    def test_role_based_schema_input_object_validation(self, hge_ctx):
        check_query_f(
            hge_ctx, f'{self.dir()}role_based_schema_input_object_validation.yaml'
        )

    def test_role_based_schema_object_validation(self, hge_ctx):
        check_query_f(hge_ctx, f'{self.dir()}role_based_schema_object_validation.yaml')

    def test_preset_directive_validation(self, hge_ctx):
        check_query_f(hge_ctx, f'{self.dir()}argument_preset_validation.yaml')
...
class TestRemoteSchemaPermissionsExecution:
    ...
    def test_execution_with_subset_of_fields_exposed_to_role(self, hge_ctx):
        ...
        check_query_f(
            hge_ctx,
            f'{self.dir()}execution_with_partial_fields_exposed_to_role.yaml',
        )
    ...
    def test_execution_with_subset_of_fields_exposed_to_role_with_caching(self, hge_ctx):
        ...
        check_query_f(
            hge_ctx,
            f'{self.dir()}execution_with_partial_fields_exposed_to_role_cached.yaml',
        )
    ...
    def test_execution_with_subset_of_arguments_exposed_to_role(self, hge_ctx):
        ...
        check_query_f(
            hge_ctx,
            f'{self.dir()}execution_with_partial_args_exposed_to_role.yaml',
        )

    def test_execution_with_unknown_role(self, hge_ctx):
        check_query_f(hge_ctx, f'{self.dir()}unknown_role_execution.yaml')
...
class TestRemoteSchemaPermissionsArgumentPresets:
    ...
    def test_execution_with_static_argument_preset(self, hge_ctx):
        hge_ctx.v1metadataq_f(
            f'{self.dir()}add_permission_with_static_preset_argument.yaml'
        )
        check_query_f(hge_ctx, f'{self.dir()}execution_with_static_preset_args.yaml')

    def test_execution_with_session_argument_preset(self, hge_ctx):
        hge_ctx.v1metadataq_f(
            f'{self.dir()}add_permission_with_session_preset_argument.yaml'
        )
        check_query_f(hge_ctx, f'{self.dir()}execution_with_session_preset_args.yaml')
...
class TestRemoteRelationshipPermissions:
    ...
    def test_basic_relationship(self, hge_ctx):
        ...
        hge_ctx.v1q_f(f'{self.dir()}setup_remote_rel_basic_user.yaml')
        check_query_f(
            hge_ctx,
            f'{self.dir()}basic_remote_relationship_without_remote_schema_permissions_configured.yaml',
        )
        check_query_f(
            hge_ctx,
            f'{self.dir()}basic_remote_relationship_with_remote_schema_permissions_configured.yaml',
        )
    ...
    def test_remote_relationship_with_field_containing_preset_argument(self, hge_ctx):
        ...
        check_query_f(
            hge_ctx,
            f'{self.dir()}derive_remote_relationship_with_joining_field_containing_preset.yaml',
        )

    def test_partial_arguments_of_remote_relationship_from_preset(self, hge_ctx):
        hge_ctx.v1q_f(f'{self.dir()}setup_remote_rel_messages_single_field.yaml')
        check_query_f(hge_ctx, f'{self.dir()}partial_arguments_from_preset.yaml')
